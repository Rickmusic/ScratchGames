  ...
  Scratch.lobby.init = function() {
    ...
    switch (gameType) {
      case 'Go Fish':
        ...
        break;
      case 'UNO':
        $('#gameSettings').append('SPECIFIC GAME SETTINGS NOT FOUND');
        break;
    }
    // This will disable the newly loaded in form. Must be called after this whole function has run for not host. TODO
